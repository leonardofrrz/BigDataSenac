...
precos_array = np.genfromtxt('BigDataSenac/modulo02/vendas_produtos.csv', delimiter=',', skip_header=1, dtype=None, encoding='utf-8', usecols=3)
...
if abs(distancia) <= 0.10: #abs é pra ignorar o sinal e usar só o valor absoluto(-1 vira 1 e etc)
...
df_produtos = pd.read_csv('BigDataSenac/modulo02/vendas_produtos.csv')
